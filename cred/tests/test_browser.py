...
class JavascriptTests(LiveServerTestCase):
    ...
    # FIXME AssertionError: u'http://localhost:8081/?next=/cred/list/' != u"http://localhost:8081/cred/list-by-search/_secr3t.p@ssw()rd'ste5t!/"
    ...
    # FIXME NoSuchElementException: Message: Unable to locate element: [id="id_iconname"]
