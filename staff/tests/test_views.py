...
class StaffViewTests(TestCase):
    ...
    def test_userdetail(self):
        resp = self.data.staff.get(reverse('staff:userdetail', args=(self.data.unobody.id,)))
        self.assertEqual(resp.status_code, 200)
    ...
    def test_groupadd(self):
        resp = self.data.staff.get(reverse('staff:groupadd'))
        self.assertEqual(resp.status_code, 200)
        ...
        resp = self.data.staff.post(reverse('staff:groupadd'), post, follow=True)
        self.assertEqual(resp.status_code, 200)
        # Make sure we can get the object without exception
        Group.objects.get(name='Test Group')

    def test_groupdetail(self):
        resp = self.data.staff.get(reverse('staff:groupdetail',
    ...
    def test_groupdelete(self):
        resp = self.data.staff.get(reverse('staff:groupdelete',
            args=(self.data.othergroup.id,)))
        self.assertEqual(resp.status_code, 200)
        group = resp.context['group']
        self.assertEqual(self.data.othergroup.id, group.id)
        resp = self.data.staff.post(reverse('staff:groupdelete',
    ...
    def test_userdelete(self):
        resp = self.data.staff.get(reverse('staff:userdelete',
            args=(self.data.unobody.id,)))
        self.assertEqual(resp.status_code, 200)
        user = resp.context['viewuser']
        self.assertEqual(self.data.unobody.id, user.id)
        resp = self.data.staff.post(reverse('staff:userdelete',
    ...
    def test_audit_by_cred(self):
        resp = self.data.staff.get(reverse('staff:audit',
    ...
    def test_audit_filtering(self):
        ...
        resp = self.data.staff.post(reverse('staff:audit',
            args=("days", 2)), post)
        self.assertEqual(resp.status_code, 200)
        days_ago = resp.context['item']
        loglist = resp.context['logs'].object_list
    ...
    def test_NewUser(self):
        resp = self.data.staff.get(reverse('staff:user_add'))
        self.assertEqual(resp.status_code, 200)
        form = resp.context['form']
        post = {}
        for i in form:
        ...
        resp = self.data.staff.post(reverse('staff:user_add'), post, follow=True)
    ...
    def test_UpdateUser(self):
        resp = self.data.staff.get(reverse('staff:user_edit', args=(self.data.unobody.id,)))
        self.assertEqual(resp.status_code, 200)
        form = resp.context['form']
        post = {}
        for i in form:
        ...
        resp = self.data.staff.post(reverse('staff:user_edit', args=(self.data.unobody.id,)), post, follow=True)
        self.assertEqual(resp.status_code, 200)
    ...
    def test_credundelete(self):
        ...
        resp = self.data.staff.get(reverse('staff:credundelete', args=(self.data.cred.id,)))
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(resp.context['cred'], self.data.cred)
        resp = self.data.staff.post(reverse('staff:credundelete', args=(self.data.cred.id,)), follow=True)
        self.assertEqual(resp.status_code, 200)
